...
#include "Utf.h"          // <-- добавить эту строку
#include "Input.h"
#include <cmath>
...
void UpgradeViewer::createEntries()
{
    ...
    for (size_t i = 0; i < m_AcquiredUpgrades.size(); ++i)
    {
        ...
        switch (entry.type)
        {
        case UpgradeType::HEALTH_BOOST:    entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::DAMAGE_BOOST:    entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::SPEED_BOOST:     entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::FIRE_RATE_BOOST: entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::REGENERATION:    entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::PIERCING_SHOTS:  entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::EXPLOSIVE_SHOTS: entry.iconSymbol.setString(u8("??")); break;
        case UpgradeType::LIFESTEAL:       entry.iconSymbol.setString(u8("??")); break;
        case UpgradeType::DOUBLE_SHOT:     entry.iconSymbol.setString(u8("??")); break;
        case UpgradeType::SHIELD_CHARGE:   entry.iconSymbol.setString(u8("??")); break;
        case UpgradeType::DASH_RESET:      entry.iconSymbol.setString(u8("?")); break;
        case UpgradeType::GREED:           entry.iconSymbol.setString(u8("??")); break;
        case UpgradeType::CRITICAL_HIT:    entry.iconSymbol.setString(u8("?")); break;
        default:                           entry.iconSymbol.setString(u8("?")); break;
        }
